...
export class BookingCardComponent {
  ...
  @Output() typeBooking = new EventEmitter<string>();
  ...
  booking = [
    ...
    { img: "../../../assets/img/pub.png", title: 'Pub', description: 'Zona VIP de jueves a domingo por la noche en horario de 24:00 a 03:00, disfruta de una experiencia exclusiva y personalizada.' },
  ...
  emitBooking(type: string) {
    this.typeBooking.emit(type);
  }
}
